...
12. Implement a code to find the second largest number in a given list of integers. 1 2 S 
...
29. Write a code that takes a tuple and an element as input. The function should 
return the count of occurrences of the given element in the tuple. 
30. Develop a code that prompts the user to input two sets of strings. Then, print the symmetric difference of these two sets. 
31. Write a code that takes a list of words as input and returns a dictionary where the keys are 
